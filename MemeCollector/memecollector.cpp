...
void MemeCollector::on_clipboard() {
...
void MemeCollector::on_selection_changed() {
...
void MemeCollector::connect_signals() {
	...
	QObject::connect(radioURL, &QRadioButton::clicked, this, &MemeCollector::on_URL);
	QObject::connect(radioClipboard, &QRadioButton::clicked, this, &MemeCollector::on_clipboard);
	QObject::connect(radioPcDir, &QRadioButton::clicked, this, &MemeCollector::on_pc_dir);
	...
	QObject::connect(tableWidget, &QTableWidget::itemSelectionChanged, this, &MemeCollector::on_selection_changed);
}
...
void MemeCollector::connect_menus() {
	...
	QObject::connect(
		...
		[&](const QPoint &point) { menuEdit->exec(tableWidget->viewport()->mapToGlobal(point)); }
	);
